...
export const APPS_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbymkuAYWaNa9Y6EcEhHUcOuc1U5zR6OnmS-3ta9mq0PBrWgJudJsWtuWRkM922dQtpEYw/exec";
  ...
  if (json && json.status === "success") {
    ...
    const correspondence = rawKorespondencja.map((item, idx) => {
      ...
      return {
        ...
        date,
        data: date,
        dataWyslania: item.dataWyslania || '',
        dataWplywu: item.dataWplywu || item.data || item.date || date,
